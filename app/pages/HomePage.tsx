    ...
    <div className="home-page">
        <div className="content">
            <div className="about-me">
                <h1>Katherine Charry</h1>
                <h2>Hello World!</h2>
                <p>I’m a second-year Computer Science student at the University of California, San Diego. 
            ...
            <img className="profile-pic" src="/imgs/profile-pic.JPG" alt="Profile Picture" />
        </div>
